defmodule Cyclium.Schemas.Episode do
  ...
  def changeset(episode, attrs) do
    episode
    |> cast(attrs, [
      :actor_id, :expectation_id, :spec_rev, :trigger_type, :trigger_ref,
      :dedupe_key, :status, :phase, :budget, :turns_used, :tokens_used,
      :attempts, :max_attempts, :classification, :confidence, :summary,
      :log_strategy, :error_class, :error_detail, :workflow_instance_id,
      :workflow_step_id, :started_at, :finished_at, :queued_at
    ])
